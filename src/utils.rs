...
Default target: x86_64-apple-macosx\n",
        ...
        "python -c from importlib.resources import files;print(files('dbt')._paths[0]);" => Some(CommandOutput {
        ...
        "python3 -c from importlib.resources import files;print(files('dbt')._paths[0]);" => Some(CommandOutput {
            stdout: if cfg!(target_os = "windows") {
                String::from("\\site-packages\\dbt\n")
            }
            else {
